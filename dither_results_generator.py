...
data_directory = './QIM_data/decode_results/delta_5_100_half_newsigma/'
...
# match_string = re.compile(r'sigma_0-0048_uniform_add_bs[0-9]*_dr8_[0-9]*_CORR.npy')
# match_string = re.compile(r'sigma_0-0_uniform_add_bs[0-9]*_dr8_[0-9]*_BER.npy')
match_string = re.compile(r'sigma_0-0144_uniform_add_bs[0-9]*_dr8_[0-9]*_BER.npy')
##################
...
results_file = './QIM_data/decode_results/delta_5_100_half_results/BER_DRall_BSall_00144Sig_delta005.csv' 
